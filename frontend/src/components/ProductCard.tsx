...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <article className="flex h-full min-w-0 flex-col overflow-hidden rounded-2xl border border-[var(--color-border)] bg-[var(--color-card-bg)] shadow-panel transition hover:border-[var(--color-primary)]/60">
      <div className="aspect-square overflow-hidden bg-[#0D0D0D] sm:aspect-[4/3]">
